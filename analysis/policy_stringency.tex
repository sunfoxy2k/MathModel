...
Duplicate Name SCRIPTS\_DIR
/home/phuc/Desktop/Work/Data Sience/Epidemic
Modeling/MathModel/data/raw/OurWorldInData/scripts/scripts
/home/phuc/Desktop/Work/Data Sience/Epidemic
Modeling/MathModel/data/raw/OurWorldInData/scripts
Duplicate Name DATA\_DIR
/home/phuc/Desktop/Work/Data Sience/Epidemic
Modeling/MathModel/data/raw/OurWorldInData/public/data
/home/phuc/Desktop/Work/Data Sience/Epidemic Modeling/MathModel/data
Duplicate Name WHO\_DIR
/home/phuc/Desktop/Work/Data Sience/Epidemic
Modeling/MathModel/data/raw/OurWorldInData/public/data/who
/home/phuc/Desktop/Work/Data Sience/Epidemic
Modeling/MathModel/data/raw/OurWorldInData/scripts/input/who
Duplicate Name ECDC\_DIR
/home/phuc/Desktop/Work/Data Sience/Epidemic
Modeling/MathModel/data/raw/OurWorldInData/public/data/ecdc
/home/phuc/Desktop/Work/Data Sience/Epidemic
Modeling/MathModel/data/raw/OurWorldInData/scripts/input/ecdc
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{confirmed} \PY{o}{=} \PY{n}{file}\PY{o}{.}\PY{n}{load\PYZus{}pickle}\PY{p}{(}\PY{n}{file\PYZus{}path}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CUMUMLATIVEDAILY\PYZus{}CONFIRMED\PYZus{}PKL\PYZus{}PATH}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}

\PY{n}{dat} \PY{o}{=} \PY{n}{data\PYZus{}process}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{n}{file\PYZus{}path}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{OWID\PYZhy{}COVID\PYZhy{}DATA\PYZus{}CSV\PYZus{}PATH}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}

\PY{n}{nations} \PY{o}{=} \PY{n}{confirmed}\PY{o}{.}\PY{n}{columns}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
Loaded file cumumlativedaily\_confirmed.pkl
    \end{Verbatim}
...
Saved file policy\_stringency.pkl
    \end{Verbatim}
