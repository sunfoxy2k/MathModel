...
\section{Code}\label{code}}
    ...
    \hypertarget{craw-eu-population-in-wikipedia}{%
\subsection{Craw EU population in
Wikipedia}\label{craw-eu-population-in-wikipedia}}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{7}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{url} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}}
\PY{l+s+s2}{https://en.wikipedia.org/wiki/}\PY{l+s+se}{\PYZbs{}}
\PY{l+s+s2}{Area\PYZus{}and\PYZus{}population\PYZus{}of\PYZus{}European\PYZus{}countries}\PY{l+s+s2}{\PYZdq{}}

\PY{n}{EU\PYZus{}poplation} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}html}\PY{p}{(}\PY{n}{url}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{EU\PYZus{}poplation} \PY{o}{=} \PY{n}{file}\PY{o}{.}\PY{n}{load\PYZus{}pickle}\PY{p}{(}\PY{n}{file\PYZus{}path}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{EU\PYZus{}POPULATION\PYZus{}PKL\PYZus{}PATH}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
Loaded file EU\_population.pkl
    \end{Verbatim}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{54}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} fix different nation name between John Hopkin and our wiki data}

\PY{n}{EU\PYZus{}poplation}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{l+m+mi}{20}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Name}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Denmark}\PY{l+s+s1}{\PYZsq{}}
\PY{n}{EU\PYZus{}poplation}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{l+m+mi}{25}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Name}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{France}\PY{l+s+s1}{\PYZsq{}}
\PY{n}{EU\PYZus{}poplation}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{l+m+mi}{21}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Name}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Czechia}\PY{l+s+s1}{\PYZsq{}}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{file}\PY{o}{.}\PY{n}{save\PYZus{}pickle}\PY{p}{(}\PY{n}{dir\PYZus{}path}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{EXTERNAL\PYZus{}DIR}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/EU\PYZus{}population.pkl}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{EU\PYZus{}poplation}\PY{p}{)}

\PY{c+c1}{\PYZsh{} Save file as .csv}
\PY{n}{EU\PYZus{}poplation}\PY{o}{.}\PY{n}{to\PYZus{}csv}\PY{p}{(}\PY{n}{dir\PYZus{}path}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{EXTERNAL\PYZus{}DIR}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{+} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/EU\PYZus{}POPULATION.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{index}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
Directory  /home/phuc/Desktop/Work/Data Sience/Epidemic
Modeling/MathModel/data/external  already exists
Saved file EU\_population.pkl
    \end{Verbatim}
